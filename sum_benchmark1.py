...
def test1_function(data, iterations):
...
duration11 = test1_function(data, 1)
print("Test1 1 iteration initial duration = ", duration11)

duration12 = test1_function(data, 1)
print("Test1 1 iteration second duration = ", duration12)

duration10 = test1_function(data, 10)
print("Test1 10 iterations duration = ", duration10)

print("{},{},{},{}".format(args.num_part, duration11, duration12, duration10), file=sys.stderr)

#duration = test1_function(data, 100)
#print("Test1 100 iterations duration = ", duration)
